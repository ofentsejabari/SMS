...
public class AccessControlRights extends BorderPane{
    ...
    public AccessControlRights() {
        ...
        btn_add.setGraphic(SMS.getGraphics(MaterialDesignIcon.ACCOUNT_KEY, "icon-default", 24));
        btn_add.setOnAction((ActionEvent event) -> {
            
        });
        
        edit = new JFXButton("Edit Record");
        ...
        toolbar.getChildren().addAll(new HSpacer(), btn_add, edit, btn_refresh);
